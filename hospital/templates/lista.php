<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><i class="fa fa-dashboard"></i> Listas de atención FONASA</h2>
    </div>
    <div class="col-lg-2">
	...
	<div class="col-lg-12">
		<div class="ibox collapsed float-e-margins">
			...
			<div class="ibox-content" style="display: block;">
				<form id="frm_result" method="POST" role="form" class="form-inline" onsubmit="return calc_result();">
					<div class="form-group"><strong>Seleccione Lista</strong><br />
							<?=$cmb_lst?>
					</div>
...
function calc_result()
{
	...
	$("#resultado").html('<div class="sk-spinner sk-spinner-rotating-plane"></div>');
	$.ajax({
		type: "POST",
		url: "pages/lista.refresh.php",
		data: $("#frm_result").serialize(),
		complete: function(obj, rst)
		{
			if (rst=="success") 
			{
				$("#resultado").html(obj.responseText);
			}
		}
	});
	return false;
